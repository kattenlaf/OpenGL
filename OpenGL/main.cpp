...
int main(void) {
    ...
    glBufferData(GL_ARRAY_BUFFER, 6 * 2 * sizeof(float), positions, GL_STATIC_DRAW); //https://docs.gl/gl4/glVertexAttribPointer
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // glDrawArrays(GL_TRIANGLES, 0, 6); // No longer need glDrawArrays when using index buffers, glDrawElements instead
